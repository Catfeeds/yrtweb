(function (g) {
    var o = function (a, d, c) {
        ...
        if (1 < b.defs.total && "bar" != b.defs.timer) {
            var k = "180bar" == b.defs.timer ? c.timerStroke : 0,
            i = l + 2 * h + 2 * k,
            j = i,
            ...
            a.customAttributes.arc = function (a, b) {
                ...
                d = f - b * Math.sin(d);
                return {
                    path: 180 == a ? [["M", e, f - b], ["A", b, b, 0, 1, 1, 299.99, f - b]] : [["M", e, f - b], ["A", b, b, 0, +(180 < c), 1, g, d]]
                }
            };
            ...
            1 < b.defs.total && "pie" == b.defs.timer && a.circle(m + h, m + h, m + h - 1).attr(q);
            b.timerBgPath = a.path().attr(d);
            b.timerPath = a.path().attr(o);
            b.pieTimer = a.path().attr(p)
        }
        1 < b.defs.total && "180bar" == b.defs.timer && b.timerBgPath.attr({
            arc: [359.9, m]
        });
        ...
        0 < b.defs.images.length ? new n(b.defs.images,
        function (a) {
            a = a * 10;
            f.stop().animate({
                width: a + "%"
    ...
    o.prototype = {
        ...
        goSlide: function (a, d, c) {
            ...
            b.slides.find(".player_masker").show();
            b.slides.find(".baby_masker").show();
            b.defs.lock = !0;
            b.layout(!0, a);
            if (c) return !1;
            b.resetTimer();
        ...
        processTimer: function () {
            if ("180bar" == this.defs.timer) {
                ...
                width: 100 * (this.defs.degree / 180) + "%"
            });
            this.defs.degree += 4
        },
        resetTimer: function () {
            1 < this.defs.total && ("180bar" == this.defs.timer ? this.timerPath.animate({
                arc: [0, this.R]
            },
        ...
        layout: function (a, d) {
            ...
            this.defs.currentSlide.find(".player_masker").hide();
            this.defs.currentSlide.find(".baby_masker").hide();
            ...
            }) : a ? this.defs.currentSlide.animate({
                left: b + "px",
                top: c + "px",
                width: this.defs.currentSlide.data("width") + "px",
                height: this.defs.currentSlide.data("height") + "px"
            ...
            e -= c + 1,
            f = this.CSS(b, c, e, !0),
            this.support.transition() ? b.css(f).css({
                opacity: 1,
                visibility: "visible",
                zIndex: e
            }) : (c == this.rightItems.length - 1 && (f.opacity = 1), a ? b.animate(f, this.options.animationSpeed, this.defs.easing) : b.css(f), c != this.rightItems.length - 1 && b.css({
                opacity: 1
            }), b.css({
                visibility: "visible",
                zIndex: e
            ...
            e -= c + 1,
            f = this.CSS(b, c, e),
            this.support.transition() ? b.css(f) : a ? b.animate(f, this.options.animationSpeed, this.defs.easing) : b.css(f),
            b.css({
                opacity: 1,
                visibility: "visible",
                zIndex: e
            ...
            this.defs.total > this.options.slides && (e = this.CSS(this.rightOutItem, this.leftItems.length - 0.5, this.leftItems.length - 1, !0), f = this.CSS(this.leftOutItem, this.leftItems.length - 0.5, this.leftItems.length - 1), this.support.transition() ? (this.rightOutItem.css(e), this.leftOutItem.css(f)) : a ? (this.leftOutItem.css({
                opacity: 1,
                visibility: "visible"
            }), this.rightOutItem.css(e), f.opacity = 0, this.leftOutItem.animate(f, this.options.animationSpeed, this.defs.easing)) : (this.rightOutItem.css(e), this.leftOutItem.css(f)))
        },
        setItems: function () {
        ...
        events: function () {
            var a = this;
            a.options.keyboardNav && g(document).bind("keyup.iCarousel",
            function (d) {
                switch (d.keyCode) {
                    case 33:
                    case 37:
            ...
            a.options.touchNav && a.support.touch() && a.el.swipe({
                swipeLeft: function () {
            ...
            a.el.bind("iCarousel:goSlide",
            function (d, c) {
                a.defs.slide != c && a.goFar(c)
            });
            a.el.bind("iCarousel:next",
            function () {
                a.goNext()
            });
            a.el.bind("iCarousel:previous",
            function () {
                a.goPrev()
            });
    ...
    g.fn.swipe = function (a) {
        ...
        g(this).each(function () {
            ...
            e = 0,
            f = 0;
            d.bind("touchstart MozTouchDown",
            function (a) {
