...
<div class="warp">
	...
	<div class="wrapper" style="margin-top: 116px;">
		...
		<div class="registration">
            <div class="reg_title">
                <span class="text-white f16 ms">我的购入</span>
            </div>
            <ul class="l_tools_one">
                <li><span><a href="${ctx}/playerTrade/list?s_id=${auctionCondition.s_id}" class="text-gray-s_666">球员列表</a></span></li>
                <li><span>|</span></li>
                <li class="active"><span>我的购入</span></li>
                <li><span>|</span></li>
	            <li><span><a href="${ctx}/playerTrade/mySalePlayers?s_id=${auctionCondition.s_id}" class="text-gray-s_666">我的出售</a></span></li>
                <div class="clearit"></div>
            </ul>
            <form action="${ctx}/playerTrade/myPlayers" method="post" id="searchForm">
            <input type="hidden" name="s_id" id="s_id" value="${auctionCondition.s_id}"/>	
            <input type ="hidden" id="currentPage" name="currentPage" value="1"/>
            <input type ="hidden" name="pageSize" value="8"/>
            <input type ="hidden" name="team_id" value="${teamInfo.id}"/>
            ...
            <ul class="l_tools_three">
                ...
                <li>
                    ...
                    <input type="submit" name="name" value="搜索" class="auction_btn ms ml10" />
                </li>
            </ul>
            </form>
            <div class="clearit"></div>
            <div class="j_fenge"></div>
            <div id="my_buy_player_data">
...
<script type="text/javascript">
	...
	function searchPage(pageIndex){
		...
		$.ajax({
			type:'post',
			url:base+"/playerTrade/buyPlays?random="+Math.random(),
			data:$("#searchForm").serialize(),
			dataType:'HTML',
			beforeSend:function(){
				$("#my_buy_player_data").empty();
				$("#my_buy_player_data").append(tempHtml);
			},
			success:function(data){
				$("#my_buy_player_data").empty();
				$("#my_buy_player_data").append(data);
			}
		});
	}
