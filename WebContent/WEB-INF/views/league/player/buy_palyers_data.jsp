...
<c:choose>
	<c:when test="${empty rf.items}">
		<div style="text-align: center;color: red;">暂无我的购入数据...</div>
	</c:when>
	<c:otherwise>
                ...
                <ul class="a_list">
                	<c:forEach items="${rf.items}" var="auction">
                        ...
                        <div class="auction_super">
                            ...
                            <dl class="quote ms">
                            	<dt><span class=" ml10 f14">联系方式</span></dt>
                                <dd><span class="text-orange ml10 f14">${auction.phone}</span></dd>
                                <dd>
                            ...
                            <div class="auc_div">
                                <c:choose>
                               		...
                               		<c:otherwise>
		                                <input type="button" id="ac_btn" class="ac_btn ms" value="购买" name="name" onclick="look_player('${auction.m_id}')">
                               		</c:otherwise>
                               	</c:choose>
