	...
	<div class="wrapper" style="margin-top: 116px;">
		...
		<div class="registration">
            ...
            <ul class="l_tools_one">
                <li><span><a href="${ctx}/auction/searchList?s_id=${auctionCondition.s_id}" class="text-gray-s_666">竞拍列表</a></span></li>
                <li><span>|</span></li>
                <li class="active"><span>我的竞拍</span></li>
                <div class="clearit"></div>
            </ul>
            <form action="${ctx}/auction/mySearchList" method="post" id="searchForm">	
            ...
            <ul class="l_tools_two">
                ...
                <li><span>|</span></li>
                <li>
                	<span onclick="getSort('bid_sort','#bid_sort');">身价</span><span id="bid_sort" style="color:#fff;"></span>	
                	<input type="hidden" name="bid_sort" class="ich" value="${auctionCondition.bid_sort}"/>
              	</li>
                <li><span>|</span></li>
                <li>
                	<span onclick="getSort('score_sort','#score_sort');">能力</span><span id="score_sort" style="color:#fff;"></span>	
            ...
            <ul class="l_tools_three">
                ...
                <li>
                    ...
                    <input type="button" name="name" value="搜索" class="auction_btn ms ml10" onclick="loadMyQueryPage(0);"/>
                </li>
            </ul>
            </form>
            <div class="clearit"></div>
