                    ...
                    <ul class="enlist_area">
                    	...
                    	<li>
                            <div class="enlist">
                                ...
                                <input type="button" onclick="toAuction('${area.id}')" value="进入市场" class="btn_l ms f14" />
                            </div>
                        </li>
                    	</c:forEach>
                    	</c:if>
...
<script type="text/javascript">
	function toAuction(id){
		window.location = base+"/auction/searchList?s_id="+id;
	}
