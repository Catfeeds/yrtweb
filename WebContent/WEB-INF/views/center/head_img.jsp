...
<body>
        <div class="container" style="width: 640px;">
            <div class="edit_title">
                ...
                <p class="mt10 ml10 f18 ms">展现出您的最佳形象</p>
                ...
                <div class="edit_z">
                    ...
                    <div class="pic_win">
                        <div onclick="up_new_imgage(this)" class="img-container" style="cursor: pointer;">
                            <img src="" alt="浏览文件" style="border: none;"/>
                        </div>
                    </div>
            ...
            <div class="btn-group">
                ...
                <label class="btn btn-primary btn-upload" for="inputButton" title="">
                    ...
                    <span class="docs-tooltip" data-toggle="tooltip" title="">
                        <span class="fa fa-upload">保存</span>
                    </span>
                </label>
            </div>
