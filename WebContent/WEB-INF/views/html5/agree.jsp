    ...
    <div class="container" style="position: relative;">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        &emsp;&emsp;组委会提示：即将前往支付宝支付。
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="window.location='${ctx}/html5/cancel'">取消</button>
                        <button type="button" class="btn btn-primary" onclick="surePay()">确定</button>
                    </div>
                </div>
            </div>
        </div>
        <div style="">
            <div class="form-group" style="padding-bottom: 55px;">
                ...
                <p class="t2">
                    宇任拓足球超级联赛（英文名Uniplay Super League，简称宇超或USL）是由成都宇任拓网络科技有限公司发起创办，成都电视台联合主办，在成都市足球协会指导下，结合互联网平台，针对业余足球运动员的首个O2O足球赛事。业余俱乐部和业余球员将在宇超获得如职业足球一般的美妙体验。
                     <p class="t2">首届宇超联赛将于2015年12月26日开始在成都谢菲联足球基地举行，为期两个月。
        ...
        <div class="sumit">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" id="sumit" onclick="signName()">
                 	 同意
                </button>
    	...
    	$.ajax({
    		...
    		success:function(data){
    			if(data.state=="success"){
					window.location=base+"/html5/result";    				
