    ...
    <table class="buytab">
        <c:choose>
	   	...
	   	<tr>
            ...
            <td><span><yt:id2NameDB beanId="teamInfoService" id="${item.buy_teaminfo_id}"></yt:id2NameDB></span></td>
            ...
            <td>
                ...
                <input type="button" onclick="loan_manage('${item.id}',1)" value="同意" class="btn_l" />
                <input type="button" onclick="loan_manage('${item.id}',2)" value="拒绝" class="btn_g" />
            		</c:if>
            		</c:otherwise>
            	</c:choose>
            </td>
	   	...
	   	<tr>
	   		<td colspan="5">
	   		<span class="text-gray-s_666 f14">暂无出租记录</span>
	   		</td>
	   	</tr>
	   	</c:otherwise>
	    </c:choose>
