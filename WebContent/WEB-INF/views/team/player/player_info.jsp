...
<div class="ability">
    ...
    <div style="width: 80%;margin: 10px auto 0;text-indent: 2.8em;line-height: 30px;">
        <p>
        	<span class="ms f14">求购价格</span>
            <input type="text" name="price" id="price" value="" valid="required num" style="width: 88px;height: 12px;line-height: 12px; margin-left: 8px;" />
            <span class="ms f14 ml5">宇币</span>
        </p>
    </div>
    <div style="width:256px;margin: 125px auto 0;text-align: center; ">
        <input type="button" name="name" value="提交" class="btn_l f18 ms" id="s_purchase" onclick="sendTransferMsg('${dataMap.user_id}');">
