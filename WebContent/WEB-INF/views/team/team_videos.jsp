                ...
                <div class="photo">
                    ...
                    <dl data-id="isme" class="mt20 ml75 pull-left">
                        ...
                        <dd id="click_btn" class="mt20">
                            <input type="button" flag="0" value="上传视频" class="uppicbtn" onclick="openUpTImgs('video')" />
                        ...
                        <div id="photo_list" class="photo_div" style="margin-left: 80px;">
                            <div id="photo_model" class="item">
                                <div class="item_img">
                                    ...
                                    <a class="video" onclick="show_video('{{f_src}}','{{create_time}}','{{id}}','{{role_type}}')"></a>
                                    <img onclick="show_video('{{f_src}}','{{create_time}}','{{id}}','{{role_type}}')" src="${filePath}/{{v_cover}}"  data-id="src">
                                    </a>
                                </div>
                            </div>
                            <div class="clearit"></div>
...
function show_center(dom,id){
	...
	$.ajaxSec({
		...
		data: {id: id,team_id : $("#team_id").val(),type: "video",state:state},
		success: function(data){
			if(data.state != 'success'){
