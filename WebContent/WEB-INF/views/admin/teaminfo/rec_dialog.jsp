...
<script type="text/javascript">
$(function(){
	ListPage.enter({context:'#content',url:'${ctx}/admin/teamInfo/selectTeam',searchForm:'#searchForm'},{type:2,not_exists:'recommendation'});
})
...
function select_team(){
	...
	if(type=='2'){
		...
		if(haveCheck){
			...
			window.parent.saveRecommend(tids);
		}
	}else{
