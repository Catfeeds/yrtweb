...
<div class="row">	
	<div class="col-lg-12">
		<div class="box">
			<form id="playForm" method="post" class="form-horizontal">
			<input type="hidden" name="role_id" value="${player.id}"/>
			<fieldset class="col-sm-12">	
			<div class="form-group">
				<div class="input-group date col-sm-4">
					<span class="input-group-addon">球员名称</span>
					<input type="text" name="role_name" value="${player.name}" valid="require len(1,60)" class="form-control">
				</div>	
			</div>
			<div class="form-group">
				<div class="input-group date col-sm-4">
