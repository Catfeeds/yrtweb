...
<style type="text/css">
body {
    background:#970102 url(${ctx}/resources/images/new_bg.jpg) no-repeat center 182px !important;
   
}
.nav {
    background: #9a090a !important;
}
.header {
    width: 100%;
    height: 90px;
    /*background: url(${ctx}/resources/images/top_l.png) repeat-x;*/
...
.index_sys, .index_me, .index_person, .index_coach, .index_club, .index_baby {
    color: #333 !important;
}
.song{
   color: #333 !important;
...
<body>
	<div class="warp">
        ...
        <a href="${ctx}/event" style="display:block; width: 1000px;height: 365px;margin: 20px auto 0;" target="blank"></a>  
        <div class="wrapper" style="margin-top: 20px;">
            ...
            <div class="container ms">
                ...
                <div class="football" data-block-text="false">
                    ...
                    <ul>
                         <li data-background="${ctx}/resources/images/banner_4.jpg">
                            <div class="flick-title"><a href="#" class="liji_s" onclick="javascript:window.location='${ctx}/bbs/list?plate_id=1nO7UrefT7nD2ffffd1'"></a></div>
                            
                        </li>
                        <li data-background="${ctx}/resources/images/banner_2.jpg">
                            <div class="flick-title"><a href="${ctx}/league/eventRecords?league_id=1" class="chakan_s"></a></div>
                        </li>
                        <li data-background="${ctx}/resources/images/banner_1.jpg">
                            <div class="flick-title"><a href="#" class="zhuxi_s" onclick="javascript:window.location='${ctx}/league/choosePage'"></a></div>
                            <div class="flick-title"><a href="#" class="p_qiuyuan_s" onclick="javascript:window.location='${ctx}/league/identity?league_id=1'"></a></div>
                        </li>
                         <li data-background="${ctx}/resources/images/banner_3.jpg">
                            <div class="flick-title"><a href="#" class="haomen_s" onclick="javascript:window.location='${ctx}/team/list'"></a></div>
                ...
                <div class="index_flow">
                    <div class="indexFlowTitle">
                        ...
                        <!--普通版<span class="text-gray f20 ">|</span>-->
                        <span class="text-white f20 ">|</span>
                        <span class="f20">
                ...
                <div class="index_video">
                 <div style="width: 100%;height:15px;background: #970102;"></div>
                    ...
                    <div style="width: 100%;height:15px;background: #970102;margin-top: 10px;"></div>
                </div>
                <!--精彩视频结束-->
                <!--动态和讯息开始-->
                <div class="dynamicAndInfo">
                    <div id="tiao" style="position:absolute;left:665px; width: 15px;height:568px;background: #970102;"></div>
                    <!--动态开始-->
                    ...
                    <div class="index_info">
                        <div class="index_dynamicTile">
                            ...
                            <span class="f12">
	                            <a href="javascript:;" onclick="load_hot_news('#news_list')" class="text-gray">综合|</a>
	                            <a href="javascript:;" onclick="load_hot_news('#news_list','1')" class="text-gray">新闻|</a>
	                            <a href="javascript:;" onclick="load_hot_news('#news_list','2')" class="text-gray">公告</a>
	                        </span>
                            <span>
