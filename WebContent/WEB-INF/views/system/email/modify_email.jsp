	                ...
	                <div class="middle">
	                	...
	                	<div class="content ms">
                       		 <div class="content_top">
                       		 	<div class="title ms">
                              	  <span class="text-white f16">修改邮箱绑定</span>
                          		</div>
                          		<!-- content start-->
                          		<form>
                                ...
                                <dl id="step_1">
                                    <dt>
                                        <span class="f14">旧邮箱</span>&nbsp;&nbsp;&nbsp;${user.email}
                                        <input type="button" name="name" value="获取验证码" class="oldbtn ml10" onclick="getCodeNum(this,'oldemail','modify')"/>
                                    </dt>
                                    <dd class="mt15">
                                ...
                                <dl id="step_2">
                                	<dt>
                                        <span class="f14">新邮箱</span>
                                        <input type="text" name="name" id="new_email" value="" class="phone_txt ml10" maxlength="38" />

                                    </dt>
                                    <dd class="mt15">
                                        <input type="button" name="name" value="发送绑定激活链接" class="pub_link ml55" onclick="getCodeNum(this,'new_email','email_link')"/>
                                    </dd>
                                </dl>
                            </div>
                          		<!-- content end-->
