...
public class Progress {
	...
	public String toString() {
		return "Progress [bytesRead=" + bytesRead + ", mbRead=" + mbRead + ", contentLength=" + contentLength
				+ ", items=" + items + ", percent=" + percent + ", speed=" + speed + ", startReatTime=" + startReatTime
				+ "]";
	} 
