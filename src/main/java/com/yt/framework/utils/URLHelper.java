...
public class URLHelper {
	...
	public static Map<String, Object> getParams4Map(HttpServletRequest request){
	 ...
	 * @return
	 */
	public static String[] getParams2(HttpServletRequest request) {
		return getParams2(getURI(request));
	}
	 ...
	 * @return
	 */
	public static String[] getParams2(String uri) {
		if (uri == null) {
			throw new IllegalArgumentException("URI can not be null");
		}
		if (!uri.startsWith("/")) {
		...
		if (mi != -1) {
			...
			params = new String[StringUtils.countMatches(paramStr, "_")];
			int fromIndex = 1;
			int nextIndex = 0;
			int i = 0;
			while ((nextIndex = paramStr.indexOf("_", fromIndex)) != -1) {
