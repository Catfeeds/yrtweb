...
public class UploadUtils {
	...
	"yyyyMM");
	public static final DateFormat YEAR_FORMAT = new SimpleDateFormat(
			"/yyyy/MMddHHmmss");
	...
	public static String generateYearName(String path, String ext) {
		return path + YEAR_FORMAT.format(new Date())
				+ RandomStringUtils.random(4, Num62.N36_CHARS) + "." + ext;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("e:/ttt" + MONTH_FORMAT.format(new Date())
				+ RandomStringUtils.random(4, Num62.N36_CHARS) + "." + "jpg");
	}
