...
public abstract class ImageUtils {
	...
	public static final String[] IMAGE_EXT = new String[] { "jpg", "jpeg",
			"gif", "png", "bmp","pjpeg" };
	//create by gl 2015.08.25
	public static final String[] VIDEO_EXT = new String[] { "mp4","wmv","avi","flv","asf","mpg","mpeg","rm","rmvb","dat","mov","mkv","vob","x-ms-wmv" };
	 ...
	 * @param ext
	 * @autor gl
	 * @return 'avi,mp4,rmvb,flv,swf,wmv' 为文件后缀名者为视频
	 */
	 ...
	 * @return
	 */
	public static String subResouceUrl(String url,String path) {  
